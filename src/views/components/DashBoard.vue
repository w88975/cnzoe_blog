    ...
    <div class="relative">
        <BoxView>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <RouterLink to="/admin/database" class="h-full">
                    <div class="bg-gray-100 p-4 rounded-md cursor-pointer flex flex-row items-center h-full">
                ...
                <RouterLink to="/app/favorite" class="h-full">
                    <div class="bg-gray-100 p-4 rounded-md cursor-pointer flex flex-row items-center h-full">
                        <icon-heart size="24" class="mr-2 flex-shrink-0" />
                        <span class="flex-grow">Favorite</span>
                    </div>
                </RouterLink>
            </div>
        </BoxView>
...
import { IconFile, IconImage, IconTags, IconSubscribe, IconStorage, IconXiguaColor, IconHeart } from '@arco-design/web-vue/es/icon'
