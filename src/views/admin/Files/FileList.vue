		...
		<BoxView>
			<div class="flex flex-row items-center justify-between mb-4 overflow-hidden">
				...
				<div class="flex flex-row items-center hidden sm:flex">
					...
					<!-- 设置别名按钮 -->
					<a-button type="primary" size="mini" @click="showSetAliasModal"
						class="flex-shrink-0">设置别名</a-button>
				</div>
			</div>

			<!-- 文件夹展示 -->
			<div class="w-full" @dragenter.prevent="handleDragEnter" @dragover.prevent
				...
				<!-- 预览视图 -->
				<ViewModePreview v-else :file-list="fileList" @folderClick="folderClick"
					@triggerFileUpload="triggerFileUpload" @updateSelectedFiles="updateSelectedFiles" />
	...
	<BoxView class="mt-6">
		...
		<div v-else v-for="file in uploadingFiles" :key="file.name" class="mb-4">
			...
			<div class="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
				<div class="bg-blue-500 h-full transition-all duration-300 ease-in-out"
